...
| **nv-functional-acceptance** | `skills/nv-functional-acceptance/` | Prüft die fachliche Definition of Done eines implementierten Features evidenzbasiert – von Akzeptanzkriterien, Jira und Doku bis Hilfe, Releasenotes, Sprache, Chat-Testkatalog und Handover. |
